...
extern SEXP C_gsim_packed_pack(SEXP);
extern SEXP C_gsim_packed_zero(SEXP, SEXP);
...
extern SEXP C_gsim_packed_bed_sink_create(SEXP, SEXP, SEXP, SEXP);
...
extern SEXP C_gsim_packed_hap_sink_create(SEXP, SEXP, SEXP);
...
extern SEXP C_gsim_packed_hap_reader_open(SEXP);
...
extern SEXP C_gsim_packed_bed_read_all(SEXP, SEXP, SEXP);
extern SEXP C_gsim_metadata_variant_create(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP C_gsim_metadata_sample_create(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP C_gsim_metadata_write_bim(SEXP, SEXP);
extern SEXP C_gsim_metadata_write_fam(SEXP, SEXP);
extern SEXP C_gsim_metadata_read_bim(SEXP);
extern SEXP C_gsim_metadata_read_fam(SEXP);
extern SEXP C_gsim_metadata_vcf_open(SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef call_methods[] = {
    ...
    {"C_gsim_packed_pack", (DL_FUNC) &C_gsim_packed_pack, 1},
    {"C_gsim_packed_zero", (DL_FUNC) &C_gsim_packed_zero, 2},
    ...
    {"C_gsim_packed_bed_sink_create", (DL_FUNC) &C_gsim_packed_bed_sink_create, 4},
    ...
    {"C_gsim_packed_hap_sink_create", (DL_FUNC) &C_gsim_packed_hap_sink_create, 3},
    ...
    {"C_gsim_packed_hap_reader_open", (DL_FUNC) &C_gsim_packed_hap_reader_open, 1},
    ...
    {"C_gsim_packed_bed_read_all", (DL_FUNC) &C_gsim_packed_bed_read_all, 3},
    {"C_gsim_metadata_variant_create", (DL_FUNC) &C_gsim_metadata_variant_create, 6},
    {"C_gsim_metadata_sample_create", (DL_FUNC) &C_gsim_metadata_sample_create, 5},
    ...
    {"C_gsim_metadata_read_bim", (DL_FUNC) &C_gsim_metadata_read_bim, 1},
    {"C_gsim_metadata_read_fam", (DL_FUNC) &C_gsim_metadata_read_fam, 1},
    {"C_gsim_metadata_vcf_open", (DL_FUNC) &C_gsim_metadata_vcf_open, 5},
